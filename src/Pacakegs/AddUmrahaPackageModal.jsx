...
const AddGlobalVisasPackageModal = ({ isOpen, onRequestClose, onSubmit, editPackage }) => {
  ...
  useEffect(() => {
    if (editPackage) {
      ...
      setPackageData({
        ...
        faculty: [''],
        overview: '',
        itinerary: [{ title: '', description: '', place: '', startDate: '', endDate: '', details: [{ title: 'asd', icon: 'asdas', category: 'asd', location: 'asda', room: '456', checkIn: '56', checkout: '56' }] }],
        tourOverview: '',
        inclusion: [''],
        exclusion: [''],
        timings: [{ title: '', time: '' }],
